...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    answers: [
      ...
      { text: "Study it first, look for markings or warnings", scores: { seeker: 2, shadow: 1 } },
      { text: "Wait and watch from a distance", scores: { shadow: 2, guardian: 1 } },
      { text: "Knock politely—whoever made this deserves respect", scores: { dreamer: 2, wanderer: 1 } }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answers: [
      { text: "Accept it—mystery is part of the beauty", scores: { dreamer: 2, wanderer: 1 } },
      { text: "Refuse—I need to understand what I'm accepting", scores: { seeker: 2, guardian: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Help them, but keep one eye on that pocket", scores: { shadow: 2, seeker: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Wait and observe both paths before choosing", scores: { seeker: 2, shadow: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Lie now, then find a way to make the truth survivable later", scores: { shadow: 2, guardian: 1 } }
    ]
  }
]
